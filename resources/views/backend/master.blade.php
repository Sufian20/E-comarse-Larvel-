...
<head>
        ...
        <meta content="Coderthemes" name="{{ url('/backend') }}//images/or" />
        ...
        <div id="wrapper">
            ...
            <div class="left side-menu">
                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div class="user-box">
                        <div class="user-img">
                            <img src="{{ url('/backend') }}//images/users/user.jpg" alt="user-img" title="Mat Helme" class="rounded-circle img-fluid">
                        </div>
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                              ...
                              <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    ...
                                    <li><a href="{{route("TrashCategory")}}">Trash Category</a></li>
                                </ul>
                            </li>   
                             <li>
                                <a href="javascript: void(0);"><i class="fa fa-truck"></i> <span> Shipping Orders </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                   
                                    <li><a href="{{route("ViewShpping")}}">View Shipping</a></li>
                                    <li><a href="{{route("TrashCategory")}}">Trash Shipping</a></li>
                                </ul>
                            </li>  
                            <li>
                            ...
                            <li>
                                <a href="javascript: void(0);"><i class="fi-mail"></i><span> Sub Category </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{route("AddSubCategory")}}">Add Category</a></li>
                                    <li><a href="{{route("ViewSubCategory")}}">View Category</a></li>
                                   
                                </ul>
                            </li>

                                <li>
                                <a href="javascript: void(0);"><i class="fi-mail"></i><span> Product </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{route("AddProduct")}}">Add Product</a></li>
                                    <li><a href="{{route("ViewProduct")}}">View Product</a></li>
                                    <li><a href="{{route("TrashProduct")}}">Trash Product</a></li>
                                ...
                                <li>
                                <a href="javascript: void(0);"><i class="fi-mail"></i><span> Blog </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{route("Blog")}}">Add Blog</a></li>
                                    <li><a href="{{route("ViewBlog")}}">View Blog</a></li>
                                    <li><a href="{{route("TrashProduct")}}">Trash Blog</a></li>
                                ...
                                <li>
                                <a href="javascript: void(0);"><i class="fi-mail"></i><span> Testmonial </span> <span class="menu-arrow"></span></a>
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{route("AddTestMonial")}}">Add Testmonial</a></li>
                                    <li><a href="{{route("ViewProduct")}}">View Testmonial</a></li>
                                    <li><a href="{{route("TrashProduct")}}">Trash Testmonial</a></li>
                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                            ...
                            <li class="dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-lg">
                                    ...
                                    <div class="slimscroll" style="max-height: 230px;">
                                        ...
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="{{ url('/backend') }}//images/users/avatar-3.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                        ...
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="{{ url('/backend') }}//images/users/avatar-4.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                        ...
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="{{ url('/backend') }}//images/users/avatar-5.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                        ...
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="{{ url('/backend') }}//images/users/avatar-6.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    <img src="{{ url('/backend') }}//images/users/user.jpg" alt="user" class="rounded-circle"> <span class="ml-1">{{ Auth::user()->name }} <i class="mdi mdi-chevron-down"></i> </span>
                                </a>
